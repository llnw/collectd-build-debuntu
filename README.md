...
* Fetch the [current version] and save it as `collectd_5.4.1-llnw5.orig.tar.gz`
  in the root of this repo
* Extract the source tree into 'collectd/':

    `tar xvzf collectd_5.4.1-llnw5.orig.tar.gz -C collectd --strip-components=1`
* `cd collectd`
...
* `dch` - add a changelog entry and match the version to the new dist version
  ...
  [current version]: https://github.com/llnw/collectd/releases/download/collectd-5.4.1-llnw5/collectd-5.4.1.llnw5.tar.gz
